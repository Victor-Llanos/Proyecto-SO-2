...
public class Admin {
    ...
    public void addPhone() {
        ...
        int buttonProbs = ThreadLocalRandom.current().nextInt(1, probs);

        int total = 0;

        int screenProbs2 = ThreadLocalRandom.current().nextInt(1, probs);
        int pinProbs2 = ThreadLocalRandom.current().nextInt(1, probs);
        int camProbs2 = ThreadLocalRandom.current().nextInt(1, probs);
        int buttonProbs2 = ThreadLocalRandom.current().nextInt(1, probs);

        int total2 = 0;

        int screenProbs3 = ThreadLocalRandom.current().nextInt(1, probs);
        int pinProbs3 = ThreadLocalRandom.current().nextInt(1, probs);
        int camProbs3 = ThreadLocalRandom.current().nextInt(1, probs);
        int buttonProbs3 = ThreadLocalRandom.current().nextInt(1, probs);
